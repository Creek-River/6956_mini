...
ADE_GameMode::ADE_GameMode() { // コンストラクタ
	...
	static ConstructorHelpers::FClassFinder<APlayerController> PTClass(TEXT("/Game/ThirdPersonCPP/Blueprints/BP_DE_PlayerController"));

	if (PTClass.Class != NULL) {
		PlayerControllerClass = PTClass.Class;
	}
